...
execute if entity @s[tag=cgn.double_edged_sword.pulse.hit_ground] if block ^ ^ ^0.5 #cgn:raycast_ignore run return run function cgn:entity/projectile/double_edged_sword_pulse/drop_item

execute unless block ^ ^ ^0.5 #cgn:raycast_ignore run return run execute if entity @s[tag=!cgn.double_edged_sword.pulse.hit_ground] run function cgn:entity/projectile/double_edged_sword_pulse/hit_block
