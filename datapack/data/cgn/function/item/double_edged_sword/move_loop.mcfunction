...
execute positioned ~-0.9 ~-0.9 ~-0.9 as @n[type=!#cgn:inanimate,predicate=cgn:entity_properties/can_be_damaged,dx=0] run function cgn:item/double_edged_sword/hit with storage cgn:temp root.double_edged_sword
